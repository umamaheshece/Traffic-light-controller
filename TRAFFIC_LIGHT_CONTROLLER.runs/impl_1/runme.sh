...
HD_PWD='C:/Users/umama/TRAFFIC_LIGHT_CONTROLLER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc.tcl -notrace
